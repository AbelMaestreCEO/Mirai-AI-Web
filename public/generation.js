...
(function () {
    ...
    function renderResult(data) {
        ...
        if (tab === 'texto') {
            ...
            showResult({
                ...
                badge,
                body: {
                    html: `<div class="gen-text-output">${escaped}</div>`,
                    actions: buildCopyBtn(text)
                }
            });
        }
        ...
        // Imagen
            ...
            showResult({
                ...
                badge,
                body: {
                    html: `<img class="gen-image-output" src="${escAttr(url)}" alt="Imagen generada" loading="lazy">`,
                    actions: buildDownloadBtn(url, 'imagen-mirai.png') + buildCopyUrlBtn(url)
                }
            });
        }
        ...
        // Vídeo
            ...
            showResult({
                ...
                body: {
                    ...
                    actions: buildDownloadBtn(url, 'video-mirai.mp4')
                }
            });
        }
        ...
        // Música
            ...
            showResult({
                ...
                badge,
                body: {
                    html: `<audio class="gen-audio-output" controls src="${escAttr(url)}"></audio>`,
                    actions: buildDownloadBtn(url, 'musica-mirai.mp3')
                }
            });
        }
    }
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Mostrar solo el panel activo al inicio (evita conflictos CSS)
        document.querySelectorAll('.gen-panel').forEach(p => p.style.display = 'none');
        ...
        // Enviar con botón
        $('gen-send-btn').addEventListener('click', () => {
